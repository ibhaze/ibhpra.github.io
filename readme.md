...
.outcome-container p {
    margin-top: 10px; /* Adjust the spacing between icon and text */
...
::-webkit-scrollbar-track {
  background: #090909; /* Background color of the track */
}

/* Handle (the draggable scrolling mechanism) */
...
/* Styling for the text with a fade-in effect */
.fade-in-text {
  opacity: 0;
...
/* Hover Effect */
a:hover {
  color: #FFD700; /* Lighter shade of orange on hover */
  transition: color 0.3s ease; /* Smooth color transition when the user hovers over a link*/
}
...
.icon-explanation li .icon {
  width: 30px;
  height: auto;
  margin-right: 10px;
}

.icon-explanation li p {
  margin: 0;
  font-size: 0.9rem;
}
